...
bool Redis::subscribe(int channel)
{
    ...
    // {
    //     cout << "subscibe command failed" << endl;
    //     return false;
    // }
    ...
    //     {
    //         cout << "subscribe command failed in write" << endl;
    //         return false;
    //     }
    // }
    redisReply *reply = (redisReply*)redisCommand(subcribe_context_, "SUBSCRIBE %d", channel);
    ...
    cout << "redis subscribe success!" << endl;
    return true;
}
...
bool Redis::unsubscribe(int channel)
{
    ...
    redisReply *reply = (redisReply*)redisCommand(subcribe_context_, "UNSUBSCRIBE %d", channel);

    if (reply == NULL) {
        std::cerr << "Failed to unsubscribe to channel" << std::endl;
        redisFree(subcribe_context_);
        return false;
    }
...
void Redis::observer_channel_message()
{
    ...
    cout << "----------------------- oberver_channel_message quit--------------------------" << endl;
}
